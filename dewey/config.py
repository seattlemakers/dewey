...
# Physical paper width in printer dots.
# NOTE: if text wraps into two columns, halve this value (e.g. 384→192).
PRINTER_DOTS_PER_LINE = int(os.getenv("DEWEY_PRINTER_DOTS_PER_LINE", "192"))
...
PRINTER_HEAT_TIME = int(os.getenv("DEWEY_PRINTER_HEAT_TIME", "255"))
# Heating interval between dot groups (unit: 10µs, range 0-255, default 40)
PRINTER_HEAT_INTERVAL = int(os.getenv("DEWEY_PRINTER_HEAT_INTERVAL", "255"))
...
PRINTER_BREAK_TIME = int(os.getenv("DEWEY_PRINTER_BREAK_TIME", "7"))
