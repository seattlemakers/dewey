...
SYSTEM_INSTRUCTION = (
    ...
    '                      // For high-value components (SBC, MCU, DEV), prioritize common product name and model (e.g. Raspberry Pi 3 Model B, Arduino Uno R3, ESP32-WROOM-32) in part_number rather than raw chip-level designations (e.g. BCM2837, ATmega328P) if known.\n'
